...
/*   Updated: 2018/10/17 20:19:54 by ljoly            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	char		*name;
	void		(*hash)(uint32_t *meta, size_t blocks, t_flags *flags, char *arg);
}				t_hash;

t_hash		g_hash;
// void		(*g_hash)(uint32_t *meta, size_t blocks, t_flags *flags, char *arg);
...
void			hash_sha224(uint32_t *meta, size_t blocks, t_flags *flags, char *arg);
